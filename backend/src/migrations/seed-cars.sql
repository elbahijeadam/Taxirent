...
VALUES
  ('Skoda', 'Octavia',    2018, 'Gris Vert', 'SK-001-OCT', 'sedan',    'manual',    'diesel',   5, 4, 0, 0, 'Berline Skoda Octavia 1.6 TDI.',       '[]', '[]'),
  ('Skoda', 'Kodiaq',     2020, 'Noir',      'SK-002-KOD', 'suv',      'automatic', 'petrol',   5, 5, 0, 0, 'SUV Skoda Kodiaq 1.5 TSI E85.',        '[]', '[]'),
